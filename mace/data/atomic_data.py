...
class AtomicData(torch_geometric.data.Data):
    ...
    @classmethod
    def from_config(
        cls, config: Configuration, z_table: AtomicNumberTable, cutoff: torch.Tensor,
    ) -> "AtomicData":

        # Get edge index for largest cutoff
        ...
        edge_index_mask = (torch.tensor(edge_distance, device=cutoff.device) < cutoff[:, None]).numpy()
